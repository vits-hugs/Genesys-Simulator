...
compiler_moc_header_make_all: moc_CodeEditor.cpp moc_dialogBreakpoint.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_CodeEditor.cpp moc_dialogBreakpoint.cpp moc_mainwindow.cpp
