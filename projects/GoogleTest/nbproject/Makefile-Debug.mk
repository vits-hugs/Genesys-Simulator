...
${OBJECTDIR}/_ext/581eeaf4/gtest-all.o: ../../source/googletest/src/gtest-all.cc nbproject/Makefile-${CND_CONF}.mk
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../source/googletest -I../../source/googletest/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/581eeaf4/gtest-all.o ../../source/googletest/src/gtest-all.cc

${OBJECTDIR}/_ext/581eeaf4/gtest_main.o: ../../source/googletest/src/gtest_main.cc nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/_ext/581eeaf4
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../source/googletest -I../../source/googletest/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/581eeaf4/gtest_main.o ../../source/googletest/src/gtest_main.cc
