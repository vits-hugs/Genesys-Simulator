//// File automatically generated by GenESyS CppForG plugin//#include <iostream>
#include <string>
...
void _onDispatchEvent_CppForG_1(Model* model) {
	// user code
...
extern "C" void onDispatchEvent_CppForG_1(Model* model) {
	try {
		_onDispatchEvent_CppForG_1(model);
