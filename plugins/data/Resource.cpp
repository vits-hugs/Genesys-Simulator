...
Resource::Resource(Model* model, std::string name) : ModelDataDefinition(model, Util::TypeOf<Resource>(), name) {
    ...
    // ...
    PropertySetterBase* prop1= (PropertySetterBase*)new PropertySetterUInt(Util::TypeOf<Resource>(), "Capacity",
                                                    DefineGetterUInt<Resource>(this, &Resource::getCapacity),
                                                    DefineSetterUInt<Resource>(this, &Resource::setCapacity));
