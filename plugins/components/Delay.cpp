...
Delay::Delay(Model* model, std::string name) : ModelComponent(model, Util::TypeOf<Delay>(), name) {
    PropertySetterBase* prop1 = (PropertySetterBase*)new PropertySetterString(Util::TypeOf<Delay>(), "Delay Expression",
                DefineGetterString<Delay>(this, &Delay::delayExpression),
                DefineSetterString<Delay>(this, &Delay::setDelayExpression));
    model->getControls()->insert(prop1);
    _addProperty(prop1);
    PropertySetterBase* prop2 = (PropertySetterBase*)new PropertySetterTimeUnit(Util::TypeOf<Delay>(), "Delay Time Unit",
                DefineGetterTimeUnit<Delay>(this, &Delay::delayTimeUnit),
                DefineSetterTimeUnit<Delay>(this, &Delay::setDelayTimeUnit));
