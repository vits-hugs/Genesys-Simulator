...
/* 
 * File:   Example_AnElectronicAssemblyAndTestSystem.cpp
 * Author: rlcancian
 * 
...
int AnElectronicAssemblyAndTestSystem::main(int argc, char** argv) {
	...
	release1->getNextComponents()->insert(seize3);
	seize3->getNextComponents()->insert(delay3);
	delay3->getNextComponents()->insert(release3);
	release3->getNextComponents()->insert(decide1);
	create2->getNextComponents()->insert(assign2);
	assign2->getNextComponents()->insert(seize2);
	seize2->getNextComponents()->insert(delay2);
	delay2->getNextComponents()->insert(release2);
	release2->getNextComponents()->insert(seize3);
	decide1->getNextComponents()->insert(seize4);
	seize4->getNextComponents()->insert(delay4);
	delay4->getNextComponents()->insert(release4);
	release4->getNextComponents()->insert(decide2);
	decide2->getNextComponents()->insert(record1);
	record1->getNextComponents()->insert(dispose1);
	decide2->getNextComponents()->insert(record2);
	record2->getNextComponents()->insert(dispose2);
	decide1->getNextComponents()->insert(record3);
	record3->getNextComponents()->insert(dispose3);
	...
	//save the model
	model->save("./models/Example_AnElectronicAssemblyAndTestSystem.txt");
