...
public:
    ...
    QDockWidget *dockWidgetElements;
    QWidget *dockWidgetContents_2;
    QVBoxLayout *verticalLayout_2;
    QListWidget *listWidget_ElementPlugins;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        dockWidgetElements = new QDockWidget(MainWindow);
        dockWidgetElements->setObjectName(QString::fromUtf8("dockWidgetElements"));
        dockWidgetElements->setFeatures(QDockWidget::DockWidgetFloatable|QDockWidget::DockWidgetMovable);
        ...
        listWidget_ElementPlugins = new QListWidget(dockWidgetContents_2);
        listWidget_ElementPlugins->setObjectName(QString::fromUtf8("listWidget_ElementPlugins"));

        verticalLayout_2->addWidget(listWidget_ElementPlugins);

        dockWidgetElements->setWidget(dockWidgetContents_2);
        MainWindow->addDockWidget(static_cast<Qt::DockWidgetArea>(1), dockWidgetElements);
        ...
        menuModel->addAction(actionComponents_2);
        menuModel->addAction(actionElements_2);
        menuModel->addSeparator();
        menuModel->addAction(actionTrace);
        menuModel->addAction(actionEvents);
        menuModel->addSeparator();
        ...
        toolBar_2->addAction(actionDocumentation);
        toolBar_2->addAction(actionSupport);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionComponents->setText(QApplication::translate("MainWindow", "Components", nullptr));
        ...
        dockWidgetComponents->setWindowTitle(QApplication::translate("MainWindow", "Component Plugins", nullptr));
        dockWidgetElements->setWindowTitle(QApplication::translate("MainWindow", "Element Plugins", nullptr));
        ...
        dockWidget->setWindowTitle(QApplication::translate("MainWindow", "Report", nullptr));
    } // retranslateUi
