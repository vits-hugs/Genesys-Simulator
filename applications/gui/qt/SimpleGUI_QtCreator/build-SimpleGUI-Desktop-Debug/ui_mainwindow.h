...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menubar->setGeometry(QRect(0, 0, 892, 24));
        ...
        dockWidgetPlugins->setWidget(dockWidgetContents_2);
        ...
        QWidget::setTabOrder(textEditReports, tabWidget);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tabModel), QCoreApplication::translate("MainWindow", "Model", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabSimulation), QCoreApplication::translate("MainWindow", "Simulation", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabReport), QCoreApplication::translate("MainWindow", "Reports", nullptr));
