...
Example_AssignWrite3Seizes::Example_AssignWrite3Seizes() {
}

int Example_AssignWrite3Seizes::main(int argc, char** argv) {
	...
	//
	model->save("./models/Example_StatationRouteSequence.txt");
	sim->start();
	return 0;
}
