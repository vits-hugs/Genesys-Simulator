...
double StatisticsDefaultImpl1::min() const {
    if (_elems > 0)
        return _min;
    else
        return 0.0;
...
double StatisticsDefaultImpl1::max() const {
    if (_elems > 0)
        return _max;
    else
        return 0.0;
...
double StatisticsDefaultImpl1::average() const {
    return _average;
}

double StatisticsDefaultImpl1::variance() const {
    return _variance;
}

double StatisticsDefaultImpl1::stddeviation() const {
    return _stddeviation;
}

double StatisticsDefaultImpl1::variationCoef() const {
    return _variationCoef;
}

double StatisticsDefaultImpl1::halfWidthConfidenceInterval() const {
    return _halfWidth;
}
...
double StatisticsDefaultImpl1::getConfidenceLevel() const {
