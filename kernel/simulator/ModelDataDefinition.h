...
public:
    ...
    std::list<PropertySetterBase *> *getProperties() const;
...
protected: // could be overriden by derived classes
    ...
    virtual void _addProperty(PropertySetterBase* property);
...
protected:
    ...
    std::list<PropertySetterBase*>* _properties = new std::list<PropertySetterBase*>();
};
//namespace\\}
