...
ModelDataDefinition::ModelDataDefinition(Model* model, std::string thistypename, std::string name, bool insertIntoModel) {
    ...
    _addProperty((PropertySetterBase*)new PropertySetterString(Util::TypeOf<ModelDataDefinition>(), "name",
    ...
    _addProperty((PropertySetterBase*)new PropertySetterBool(Util::TypeOf<ModelDataDefinition>(), "report statistics",
...
void ModelDataDefinition::setName(std::string name) {
    ...
    if (name != _name) {
        ...
        for (PropertySetterBase* control : *_parentModel->getControls()->list()) {
        ...
        for (PropertyGetterBase* response : *_parentModel->getResponses()->list()) {
...
void ModelDataDefinition::_addProperty(PropertySetterBase *property)
{
    _properties->insert(_properties->end(), property);
}

std::list<PropertySetterBase *> *ModelDataDefinition::getProperties() const
{
    return _properties;
}
