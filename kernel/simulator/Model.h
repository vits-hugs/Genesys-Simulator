...
public: // model control
	...
	bool checkExpression(const std::string expression, const std::string expressionName, std::string* errorMessage); ///< This is invoked by ModelComponents and ModelElements in their private method _check() to verify if an expression defined by user is valid or not
public: // only gets	
