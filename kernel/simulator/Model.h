...
public: // only gets
    ...
    List<PropertyGetterBase *> *getResponses() const;
    List<PropertySetterBase *> *getControls() const;
...
private: // read only public access (gets)
    ...
    List<PropertyGetterBase*>* _responsesNew;
    List<PropertySetterBase*>* _controlsNew;
