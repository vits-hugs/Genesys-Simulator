...
void pd_testTStudent() {
	for (int i=1; i<5000;i++) {
		double res = ProbabilityDistribution::tStudent(0, 0.5, 1, i);
		std::cout << "df=" << std::to_string(i) << ", t[df]=" << std::to_string(res) << std::endl;
	}
}
...
int mainTestProbabilityDistributions(int argc, char** argv) {
