...
public: // only gets
	...
	//List<PropertyBase*>* getControls() const; ///< Returns a list of values that can be externally controlled (changed). They usually correspond to input parameters in the simulation model that must be changed for an experimental design.
	//List<PropertyBase*>* getResponses() const; ///< Returns a list of exits or simulation results that can be read externally. They usually correspond to statistics resulting from the simulation that must be read for an experiment design.
	List</*PropertyBase**/PropertyBase*>* getResponses() const;
	List</*PropertyBase**/PropertyBase*>* getControls() const;
