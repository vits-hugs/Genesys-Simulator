...
void dialogBreakpoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a) {
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void) _t;
        switch (_id) {
            case 0: _t->on_comboBox_Type_activated((*reinterpret_cast<const QString(*)> (_a[1])));
                break;
            case 1: _t->on_comboBox_On_activated((*reinterpret_cast<const QString(*)> (_a[1])));
                break;
            case 2: _t->on_buttonBox_accepted();
                break;
            default:;
        }
    }
