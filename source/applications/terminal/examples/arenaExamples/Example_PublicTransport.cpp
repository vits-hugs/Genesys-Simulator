...
int Example_PublicTransport::main(int argc, char** argv) {
	...
	Create_3->setEntitiesPerCreation(1);
        Create_3->setFirstCreation(0.0);
	...
	Create_4->setEntitiesPerCreation(1);
        Create_4->setMaxCreations(2);
        Create_4->setFirstCreation(0.0);
	...
	sim->setNumberOfReplications(300);
        sim->setReplicationLength(48, Util::TimeUnit::hour);
        sim->setWarmUpPeriod(2);
