...
#include "Example_Basic_Order_Shipping.h"
...
int Example_BasicOrderShipping::main(int argc, char** argv) {
	...
	// model->load("model.gen")
        ...
        Resource_1->setReportStatistics(true);
        ...
        Resource_2->setCostPerUse(0.0);
        Resource_2->setReportStatistics(true);
	...
	Process2->setDelayExpression("tria(25, 45,60)");
        ...
        Process2->setReportStatistics(true);
	...
	Process3->setDelayExpression("tria(30, 45, 90)");
        ...
        Process3->setReportStatistics(true);
	...
	assign3->getAssignments()->insert(new Assignment(model, "", "", true)); ///
        ...
        dispose2->setReportStatistics(true);
        Dispose* dispose3 = plugins->newInstance<Dispose>(model,"Invalid Data");
        dispose3->setReportStatistics(true);
	...
	assignDay->getAssignments()->insert(new Assignment(model, "v_day", "v_day+1", true)); // TODO variable eh diff
        ...
        delay24->setReportStatistics(true);
	...
	sim->setNumberOfReplications(300);
        sim->setReplicationLength(40, Util::TimeUnit::day);
