...
public:
	...
	public:
		...
		inline double pValue() const {return _pvalue;}
		inline double testStat() const {return _testStat;}
		inline double acceptanceInferiorLimit() const {return _acceptanceInferiorLimit;}
		inline double acceptanceSuperiorLimit() const {	return _acceptanceSuperiorLimit;}
